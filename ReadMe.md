...
<br>
- Clone the repo:   <code>git clone https://github.com/NhoetKyaiteKaungLayy/telegram-auto_forwarder</code></br>
- Make a <code>.env</code> file in the root of the repo, like <a href="https://github.com/NhoetKyaiteKaungLayy/telegram-auto_forwarder/blob/main/.env.sample">.env.sample</a> and fill in the values.</br>
